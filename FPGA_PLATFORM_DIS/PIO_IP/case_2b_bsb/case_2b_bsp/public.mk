...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../sdram_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is sdram_system
SOPC_NAME := sdram_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8003020
SOPC_SYSID_FLAG += --sidp=0x8003020
ELF_PATCH_FLAG  += --sidp 0x8003020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1702331879
SOPC_SYSID_FLAG += --timestamp=1702331879
ELF_PATCH_FLAG  += --timestamp 1702331879
